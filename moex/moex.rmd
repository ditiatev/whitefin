...
df_RTS_18_22 <- df_RTS_18_22[,c(2,8,15,32)]
names(df_RTS_18_22) <- c("position","date","timeclose","profit")
str(df_strategy)
```
...
df_2008_2013_RTS_10_14 <- df_2008_2013_RTS_10_14[,c(2,9,11,17,18,29)]
df_2014_2018_RTS_10_14 <- df_2014_2018_RTS_10_14[,c(2,9,11,17,18,29)]
df_2008_2013_RTS_14_18 <- df_2008_2013_RTS_14_18[,c(2,9,11,17,18,29)]
df_2014_2018_RTS_14_18 <- df_2014_2018_RTS_14_18[,c(2,9,11,17,18,29)]

df_2019_2020_RTS_10_14 <- df_2019_2020_RTS_10_14[,c(2,9,11,17,18,29)]
df_2019_2020_RTS_14_18 <- df_2019_2020_RTS_14_18[,c(2,9,11,17,18,29)]


df_2008_2013_SI_10_14 <- df_2008_2013_SI_10_14[,c(2,9,11,17,18,29)]
df_2014_2018_SI_10_14 <- df_2014_2018_SI_10_14[,c(2,9,11,17,18,29)]
df_2008_2013_SI_14_18 <- df_2008_2013_SI_14_18[,c(2,9,11,17,18,29)]
df_2014_2018_SI_14_18 <- df_2014_2018_SI_14_18[,c(2,9,11,17,18,29)]
df_2008_2013_SI_18_22 <- df_2008_2013_SI_18_22[,c(2,9,11,17,18,29)]
df_2014_2018_SI_18_22 <- df_2014_2018_SI_18_22[,c(2,9,11,17,18,29)]

df_2019_2020_SI_10_14 <- df_2019_2020_SI_10_14[,c(2,9,11,17,18,29)]
df_2019_2020_SI_14_18 <- df_2019_2020_SI_14_18[,c(2,9,11,17,18,29)]
df_2019_2020_SI_18_22 <- df_2019_2020_SI_18_22[,c(2,9,11,17,18,29)]


names(df_2008_2013_RTS_10_14) <- c("position","date","entryprice","timeclose","exitprice","profit")
names(df_2014_2018_RTS_10_14) <- c("position","date","entryprice","timeclose","exitprice","profit")
names(df_2008_2013_RTS_14_18) <- c("position","date","entryprice","timeclose","exitprice","profit")
names(df_2014_2018_RTS_14_18) <- c("position","date","entryprice","timeclose","exitprice","profit")

names(df_2019_2020_RTS_10_14) <- c("position","date","entryprice","timeclose","exitprice","profit")
names(df_2019_2020_RTS_14_18) <- c("position","date","entryprice","timeclose","exitprice","profit")

names(df_2008_2013_SI_10_14) <- c("position","date","entryprice","timeclose","exitprice","profit")
names(df_2014_2018_SI_10_14) <- c("position","date","entryprice","timeclose","exitprice","profit")
names(df_2008_2013_SI_14_18) <- c("position","date","entryprice","timeclose","exitprice","profit")
names(df_2014_2018_SI_14_18) <- c("position","date","entryprice","timeclose","exitprice","profit")
names(df_2008_2013_SI_18_22) <- c("position","date","entryprice","timeclose","exitprice","profit")
names(df_2014_2018_SI_18_22) <- c("position","date","entryprice","timeclose","exitprice","profit")

names(df_2019_2020_SI_10_14) <- c("position","date","entryprice","timeclose","exitprice","profit")
names(df_2019_2020_SI_14_18) <- c("position","date","entryprice","timeclose","exitprice","profit")
names(df_2019_2020_SI_18_22) <- c("position","date","entryprice","timeclose","exitprice","profit")
...
rm(df_2008_2013_RTS_10_14);rm(df_2014_2018_RTS_10_14);rm(df_2019_2020_RTS_10_14)
rm(df_2008_2013_RTS_14_18);rm(df_2014_2018_RTS_14_18);rm(df_2019_2020_RTS_14_18)
rm(df_2008_2013_SI_10_14);rm(df_2014_2018_SI_10_14);rm(df_2019_2020_SI_10_14)
rm(df_2008_2013_SI_14_18);rm(df_2014_2018_SI_14_18);rm(df_2019_2020_SI_14_18)
rm(df_2008_2013_SI_18_22);rm(df_2014_2018_SI_18_22);rm(df_2019_2020_SI_18_22)
...
# read from csv
df_moex <- read.csv("./data/moex.csv")
```
### indexes
```{r}
# read from moex
